...
```bash
cp whasapo-free/backend/.env.example whasapo/backend/.env
...
Ahora, habilite SSL (https) en sus sitios web para usar todas las funciones de la aplicación, como notificaciones y envío de mensajes de audio. Una manera fácil de hacer esto es usar Certbot:

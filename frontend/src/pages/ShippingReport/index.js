    ...
    <MainContainer>
      <ConfirmationModal
        title={
          ...
          `¿Está seguro de que desea eliminar este informe?: ${deletingQuickAnswers.phone}?`
        }
      ...
      <MainHeader>
        <Title>Informe de envío de mensajes</Title>
      ...
      >
        <Table size="small">
          <TableHead>
            <TableRow>
              <TableCell align="center">Conexion</TableCell>

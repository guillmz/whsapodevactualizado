...
const longText = `
Desmarque esta opción para establecer el horario de oficina para las citas.
Cuando un usuario elige ser dirigido a un asistente, el sistema
revisa la hora y el día, si está fuera de la oficina, envía un aviso
al usuario y no se dirige al asistente elegido.
`;
            ...
            <Form>
              <DialogContent dividers>
                ...
                <div>
                  <Field
                    as={TextField}
                    label="Mensaje de transferencia de servicio"
